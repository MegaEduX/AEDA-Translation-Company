...
\begin{DoxyCompactList}\small\item\em \hyperlink{class_encomenda}{Encomenda} Comparator. \end{DoxyCompactList}\item 
struct \hyperlink{structhenc}{henc}
\begin{DoxyCompactList}\small\item\em \hyperlink{class_encomenda}{Encomenda} Hashes. \end{DoxyCompactList}\item 
...
Defines the types of the text class. \begin{Desc}
\item[Enumerator]\par
\begin{description}
